...
layout: default
title: "Yale: Topics in Causal Inference"
---
...
- Goel et al. (2010) [Predicting consumer behavior with Web search](https://www.pnas.org/doi/10.1073/pnas.1005962107), PNAS.
- Choi, Varian (2012) [Predicting the Present with Google Trends](https://people.ischool.berkeley.edu/~hal/Papers/2011/ptp.pdf), The Economic Record.
- Kleinberg et al. (2015) [Prediction Policy Problems](https://www.cs.cornell.edu/home/kleinber/aer15-prediction.pdf), AER. 
...
- Hosseinmardi et al. (2021) [Examining the consumption of radical content on YouTube](https://www.pnas.org/doi/abs/10.1073/pnas.2101967118), PNAS.
- Juul, Ugander (2022) [Comparing information diffusion mechanisms by matching on cascade size](https://www.pnas.org/doi/10.1073/pnas.2100786118), PNAS.

Friend recommendation:
- Ugander et al. (2012) [Structural Diversity in Social Contagion](https://www.pnas.org/doi/10.1073/pnas.1116502109), PNAS.
- Zignani et al. (2014) [Link and Triadic Closure Delay: Temporal Metrics for Social Network Dynamics](https://ojs.aaai.org/index.php/ICWSM/article/view/14507), ICWSM.
- Su, Sharma, Goel (2016) [The Effect of Recommendations on Network Structure](https://5harad.com/papers/wtf.pdf), WWW.
- Su et al. (2020) [An Experimental Study of Structural Diversity in Social Networks](https://ojs.aaai.org/index.php/ICWSM/article/view/7332), ICWSM.

Weak ties:
- Granovetter (1973) [The Strength of Weak Ties](https://www.cs.cmu.edu/~jure/pub/papers/granovetter73ties.pdf), AJS.
- Granovetter (1983) [The Strength of Weak Ties: A Network Theory Revisited](http://www.sietmanagement.fr/wp-content/uploads/2016/04/Granovetter-1983.pdf), Sociological Theory.
- Gee, Jones, Burke (2017) [Social Networks and Labor Markets: How Strong Ties Relate to Job Finding on Facebook's Social Network](https://www.journals.uchicago.edu/doi/10.1086/686225), J Labor Economics.
- Gee et al. (2017) [The paradox of weak ties in 55 countries](https://www.sciencedirect.com/science/article/pii/S0167268116302864), Journal of Economic Behavior & Organization.
- Rajkumar et al. (2022) [A causal test of the strength of weak ties](https://www.science.org/doi/10.1126/science.abl4476), Science.
...
- Bail et al. (2018) [Exposure to opposing views on social media can increase political polarization](https://www.pnas.org/doi/10.1073/pnas.1804840115), PNAS.
...
- Dietvorst, Simmons, Massey (2016) [Overcoming Algorithm Aversion: People Will Use Imperfect Algorithms If They Can (Even Slightly) Modify Them](https://pubsonline.informs.org/doi/10.1287/mnsc.2016.2643), Management Science.
- Vaccaro et al. (2017) [The Illusion of Control: Placebo Effects of Control Settings](https://dl.acm.org/doi/10.1145/3025453.3025985), CHI.


## Week 7 -- Content moderation (M 2/23, W 2/25) ##

- Crawford, Gillespie (2016) [What is a flag for? Social media reporting tools and the vocabulary of complaint](https://journals.sagepub.com/doi/10.1177/1461444814543163), New Media & Society.
- Gillespie (2021) [Custodians of the Internet platforms, content moderation, and the hidden decisions that shape social media](https://yalebooks.yale.edu/book/9780300261028/custodians-of-the-internet/), Yale University Press.
...
Misinformation:
- Pennycook et al. (2021) [Shifting attention to accuracy can reduce misinformation online](https://www.nature.com/articles/s41586-021-03344-2), Nature.
- Martel, Allen, Rand (2023) [Crowds Can Effectively Identify Misinformation at Scale](https://journals.sagepub.com/doi/10.1177/17456916231190388), Perspectives on Psychological Science.
- Maldita (2025) [Faster, trusted, and more useful: The impact of fact-checkers in X's Community Notes](https://maldita.es/wp-content/uploads/2025/01/WhitePaper_ENG.pdf).
- Allen, Watts, Rand (2024) [Quantifying the impact of misinformation and vaccine-skeptical content on Facebook](https://www.science.org/doi/10.1126/science.adl3819), Science.
- Vranic et al. (2025) [Global Claims: A Multilingual Dataset of Fact-Checked Claims with Veracity, Topic, and Salience Annotations](https://arxiv.org/abs/2501.03697), DHOW.

## Week 8 -- Holistic effects (M 3/2, W 3/4) ##
Guest lecture: Dr. Stephen Ragain, Reddit (3/2)

- Allcott et al. (2020) [The Welfare Effects of Social Media](https://www.aeaweb.org/articles?id=10.1257/aer.20190658), AER.
- Levy (2021) [Social Media, News Consumption, and Polarization: Evidence from a Field Experiment](https://www.aeaweb.org/articles?id=10.1257/aer.20191777), AER.
...
- Dodds, Watts (2007) [Influentials, Networks, and Public Opinion Formation](https://academic.oup.com/jcr/article/34/4/441/1789920), J Consumer Research.
- Kempe, Kleinberg, Tardos (2003) [Maximizing the spread of influence through a social network](https://dl.acm.org/doi/10.1145/956750.956769), KDD.
- Centola, Macy (2007) [Complex contagions and the weakness of long ties](https://www.jstor.org/stable/10.1086/521848), AJS.
- Centola (2010) [The spread of behavior in an online social network experiment](https://www.science.org/doi/10.1126/science.1185231), Science.
- Centola (2011) [An experimental study of homophily in the adoption of health behavior](https://www.science.org/doi/10.1126/science.1207055), Science.
- Aral, Muchnik, Sundararajan (2009) [Distinguishing influence-based contagion from homophily-driven diffusion in dynamic networks](https://www.pnas.org/doi/10.1073/pnas.0908800106), PNAS.
- Muchnik, Taylor, Aral (2013) [Social Influence Bias: A Randomized Experiment](https://www.science.org/doi/10.1126/science.1240466), Science.

Diffusion studies:
- Banerjee et al. (2013) [The Diffusion of Microfinance](https://www.science.org/doi/abs/10.1126/science.1236498), Science.
- Chami et al. (2017) [Diffusion of treatment in social networks and mass drug administration](https://www.nature.com/articles/s41467-017-01499-z), Nature Comms.
- Beaman et al. (2021) [Can Network Theory-Based Targeting Increase Technology Adoption?](https://www.aeaweb.org/articles?id=10.1257/aer.20200295), AER.
...
- Lee (2016) [Learning from Tay's introduction](https://blogs.microsoft.com/blog/2016/03/25/learning-tays-introduction/), Microsoft blog.
- Kleinberg, Raghavan (2021) [Algorithmic monoculture and social welfare](https://www.pnas.org/doi/10.1073/pnas.2018340118), PNAS.
- Park et al. (2022) [Social Simulacra: Creating Populated Prototypes for Social Computing Systems](https://dl.acm.org/doi/10.1145/3526113.3545616), UIST.
- Park et al. (2023) [Generative Agents: Interactive Simulacra of Human Behavior](https://dl.acm.org/doi/10.1145/3586183.3606763), UIST.
- Park et al. (2024) [Generative Agent Simulations of 1,000 People](https://arxiv.org/abs/2411.10109), arXiv.

## Week 11 -- Ad targetting (M 4/6, W 4/8) ##

Tracking:
- Eckersley (2010) [How Unique Is Your Web Browser?](https://link.springer.com/chapter/10.1007/978-3-642-14527-8_1), PETS.
- Narayanan (2010) [Cookies, Supercookies and Ubercookies: Stealing the Identity of Web Visitors](https://www.cs.princeton.edu/~arvindn/talks/Privacy_W2SP_2010.pdf).
...
- Wagner (2023) [Independence by permission](https://www.science.org/doi/10.1126/science.adi2430), Science.
- González-Bailón et al. (2023) [Asymmetric ideological segregation in exposure to political news on Facebook](https://www.science.org/doi/10.1126/science.ade7138), Science.
- Guess et al. (2023) [Reshares on social media amplify political news but do not detectably affect beliefs or opinions](https://www.science.org/doi/10.1126/science.add8424), Science.
- Guess et al. (2023) [How do social media feed algorithms affect attitudes and behavior in an election campaign?](https://www.science.org/doi/10.1126/science.abp9364), Science.
