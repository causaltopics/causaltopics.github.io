...
layout: default
title: "Yale S&DS 6165: Topics in Causal Inference"
---
<!--
...
## Important Links
- [Canvas](https://yale.instructure.com/courses/120750) 
...
* 20% Problem Sets (10% each)
* 60% Projects (20% each)
* 20% Attendance, participation and collegiality
...
- After that: 5 points deducted per day (per 24h, including weekends), up to 6 days.
- After that: Max grade is a 70. Must be submitted by 11:59p on the final day of semester (after that, grade is 0), and no guarantees on grading turn-around time.
